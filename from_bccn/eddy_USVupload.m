...
if USV.autoUSVs
    % USVs
    datastrings = arrayfun(@(usv_nr) sprintf('( %i, %i, %.2f, %.2f, ''%s'' )' ...
                            , experiment_id ...
    ...
    querystr = 'INSERT INTO USVs (experiment_id, call_type_id, nlx_time, duration, notes ) VALUES ';
...
%     mysql(sprintf('%s %s', querystr, strjoin(datastrings', ',')))
    ...
    datastrings = arrayfun(@(usv_nr) sprintf('( %i, %i, %.2f, %.2f )' ...
                            , experiment_id ...
                            , calltypes(usv_nr) ... % call type
        ...
        , 1:numel(USV.Start), 'UniformOutput', false)';
    querystr = 'INSERT INTO USVs (experiment_id, call_type_id, nlx_time, duration ) VALUES ';
    mysql(sprintf('%s %s', querystr, strjoin(datastrings', ',')))
end
